...
const crystalData = [
    { id: 1, name: 'Amethyst', color: 'Purple', benefit: 'Calming and intuitive', image: amethyst, description: 'Amethyst is a powerful and protective stone. It guards against psychic attack, transmuting the energy into love and protecting the wearer from all types of harm, including geopathic or electromagnetic stress and ill wishes from others.', price: 19.99 },
    ...
    { id: 3, name: 'Citrine', color: 'Yellow', benefit: 'Abundance and positivity', image: citrine, description: 'Citrine is a joyful stone with bright energy which lights up many aspects of lives of those who work with it. It has energies of optimism and warmth, imagination and manifestation.', price: 19.99 },
    { id: 4, name: 'Clear Quartz', color: 'Transparent', benefit: 'Amplifies energy and healing', image: clear, description: 'Clear Quartz is known as the "master healer" and will amplify energy and thought, as well as the effect of other crystals. It absorbs, stores, releases and regulates energy. Clear Quartz draws off negative energy of all kinds, neutralizing background radiation, including electromagnetic smog or petrochemical emanations.', price: 19.99 },
    { id: 5, name: 'Obsidian', color: 'Black', benefit: 'Protection and grounding', image: obsidian, description: 'Obsidian is a powerful cleanser of psychic smog created within your aura, and is a strong psychic protection stone. It forms a shield against negativity. It blocks psychic attack and absorbs negative energies from the environment.', price: 19.99 },
    { id: 6, name: 'Lapis Lazuli', color: 'Blue', benefit: 'Wisdom and truth', image: lapis, description: 'Lapis Lazuli is a powerful crystal for activating the higher mind and enhancing intellectual ability. It stimulates the desire for knowledge, truth and understanding, and aids the process of learning. It is excellent for enhancing memory.', price: 19.99 },
    { id: 7, name: 'Jade', color: 'Green', benefit: 'Harmony and good luck', image: jade, description: 'Jade is a stone of harmony and balance. It promotes peace and balance in life, and helps to release negative thoughts and irritability. Jade is believed to attract good luck and friendship.', price: 19.99 },
    ...
    { id: 9, name: 'Tiger/s Eye', color: 'Golden Brown', benefit: 'Confidence and willpower', image: tiger, description: 'Tiger/s Eye is a stone of protection that is also very stabilizing and grounding. It enhances integrity, willpower, self-confidence, practicality and correct use of power. It is a stone that enhances good luck, and brings prosperity, often in the form of money.', price: 19.99 },
];
...
const CrystalModal = ({ crystal, onClose, onAddToCart }) => (
...
const ExploreCrystals = ({ onAddToCart }) => {
