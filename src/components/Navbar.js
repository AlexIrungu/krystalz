...
const Navbar = ({
  ...
  const AuthButtons = () => (
    <motion.button
      ...
      whileTap={{ scale: 0.95 }}
      onClick={onShowAuth}
      className="text-white bg-black hover:bg-gray-800 px-4 py-2 rounded-md text-sm font-medium cursor-pointer transition-all duration-300 ease-in-out shadow-md"
    >
      Sign In
    </motion.button>
  );
            ...
            <div className="flex items-center space-x-3">
              <div className="flex flex-col items-start">
                <div className="relative">
                  ...
                  <p className="text-xl md:text-3xl font-bold text-gray-400 tracking-wider absolute top-0 left-0 transform translate-x-0.5 translate-y-0.5 opacity-50">
                    LUNA
                  </p>
                </div>
              </div>
              ...
              {isLoggedIn && username ? (
                <>
                  ...
                  <motion.button
                    ...
                    className="w-full text-white bg-black hover:bg-gray-800 px-3 py-2 rounded-md text-base font-medium cursor-pointer transition-all duration-300 ease-in-out"
                  >
                    Logout
                  </motion.button>
                </>
